    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <h4>Skills: Teamwork, problem solving, public speaking, machine learning.
                <br/>Source: Personal Project for Rosie Competition.
                {/* <br/><a href="https://lnkd.in/gqUVQukR" target="_blank" rel="noreferrer">View Presentation</a> */}
                </h4>
            </div>
            <div className="project">
                ...
                <h4>Skills: Embedded Systems, Soldering, Debugging, Troubleshooting, Programming (C)
                <br/>Source: Personal Project. </h4>
            ...
            <div className="project">
                ...
                <h4>Skills: Arduino, Assembly, Problem solving,Debugging, Troubleshooting.
                <br/>Source: Capstone Project. </h4>
            </div>
            {/* <div className="project">
